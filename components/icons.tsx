...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg 
        ...
        fill="currentColor"
    >
        <path d="M11.293,1.293a1,1,0,0,0,0,1.414L12,3.414,10,5.414,3.293,12.121a1,1,0,0,0,0,1.414l5.657,5.657a1,1,0,0,0,1.414,0L17,12.586l2-2,0.707-0.707a1,1,0,0,0-1.414-1.414L17.586,9,15,11.586l-1.293-1.293,9-9a1,1,0,0,0-1.414-1.414Z" />
        <path d="M4.293,19.293,2.293,17.293a1,1,0,0,1,1.414-1.414l2,2A1,1,0,0,1,4.293,19.293Z" />
        <path d="M2,7.414,7.586,2,9,3.414,3.414,9,2,7.586Z" />
        <path d="M14,21.586,20.586,15,22,16.414,15.414,23,14,21.586Z" />
    </svg>
);
